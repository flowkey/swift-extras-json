// NOTE: This was added to the Swift repo in September 2025,
// replacing the previous C function. Once the Swift version
// is used in a release, we can delete this (and the Embedded Helpers)
...
fileprivate func _finishFormatting(
  ...
  return unsafe Range(uncheckedBounds: (lower: firstDigit, upper: nextDigit))
}
